...
public class ModArmorItem extends ArmorItem {
    ...
    private void addStatusEffectForMaterial(PlayerEntity player, RegistryEntry<ArmorMaterial> mapArmorMaterial, @NotNull List<StatusEffectInstance> mapStatusEffect) {
